...
const MEASURE_HOST = process.env.MEASURE_MS_HOSTNAME || 'localhost'
const MEASURE_PORT = process.env.MEASURE_MS_SERVICE_PORT || 4000
...
module.exports = {
  ...
  MEASURE_MS: `${MEASURE_HOST}:${MEASURE_PORT}`,
